...
function getCardHTML(product) {
    ...
    return `
        <div class="my-card" style="" data-product='${productData}'>
            ...
            <div class="card-actions">
                <button type="button" class="details-btn" data-product='${productData}'>Деталі</button>
...
function attachProductCardEvents() {
    ...
    let detailButtons = document.querySelectorAll('.products-list .details-btn');
    if (detailButtons) {
    ...
    let productCards = document.querySelectorAll('.products-list .my-card');
    if (productCards) {
        productCards.forEach(function (card) {
            card.addEventListener('click', function (event) {
                if (event.target.closest('.cart-btn') || event.target.closest('.details-btn')) {
                    return;
                }
...
function renderProductModal(product) {
    if (!productModalElement) return;
    currentModalProduct = product;
    modalTitle.textContent = product.title;
    modalImage.src = `img/${product.image}`;
